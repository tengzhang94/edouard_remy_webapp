            ...
            <div class="container" style="height: 100%">
                <div class="row" style="height: 100%">
                    ...
                    <div class="row" style="height:90%;">
                        {residents}
                        <div class="col-md-11" style="padding-right:0;padding-left:0;width:16.6%;height:33%;">
                            <div style="width:100%;height:100%;">
                                ...
                                <div class="row" style="height:30%;">
                                    <div class="col-md-12" style="width:45%;padding:0px;margin:0px;margin-left:10%;height:100%;"><span style="width:100%;height:100%;font-size:14px;margin-right:0px;margin-left:30%;">{firstName} {lastName}</span></div>
                                    <div class="col-md-12" style="width:45%;padding:0px;height:100%;"><span style="width:100%;height:100%;font-size:14px;margin-left:30%;">room {Sectors_idSector}.{roomNr}</span></div>
                                </div>
                            </div>
                        </div>
                        {/residents}
